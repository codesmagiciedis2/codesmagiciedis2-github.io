...
![open key explorer](/assets/images/key-explorer/open-key-explorer2.png){:class="screenshot"}

Key explorer was built with many useful areas which make it much easier to interact with Redis server:

![key explorer](/assets/images/key-explorer/key-explorer2.png){:class="screenshot"}
...
![key operations](/assets/images/key-explorer/key-operations2.png){:class="screenshot"}